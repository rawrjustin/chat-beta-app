    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-600 to-blue-600">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 text-center">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto mb-8 sm:mb-12 px-4">
            Tired of living the default life? Upgrade to Pro, and unlock the supercharged side of Story World.
          </p>
          <button className="bg-white text-purple-600 px-8 sm:px-12 py-4 sm:py-5 rounded-xl text-lg sm:text-xl font-semibold hover:shadow-2xl hover:scale-105 transition-all">
            Subscribe
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
          ...
          <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl shadow-2xl p-8 sm:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                <div className="inline-block bg-yellow-400 text-purple-900 text-xs font-bold px-4 py-2 rounded-full mb-4">
                  MOST POPULAR
                </div>
                <h3 className="text-3xl sm:text-4xl font-bold mb-2">Pro</h3>
                <div className="flex items-baseline justify-center mb-4">
                  <span className="text-6xl sm:text-7xl font-bold">$9</span>
                  <span className="text-purple-100 ml-2 text-xl">/month</span>
                </div>
                <p className="text-purple-100 text-lg">All the perks, all the power. The best way to supercharge your world on Story World.</p>
              </div>
              ...
              <button className="w-full bg-white text-purple-600 py-4 rounded-xl text-lg font-semibold hover:shadow-xl hover:scale-[1.02] transition-all">
                Upgrade to Pro
              </button>
            </div>
          </div>
        ...
        <div className="mt-16 sm:mt-20">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-12">Explore the Best of Pro</h2>
        ...
        <div className="mt-16 sm:mt-20 text-center">
          ...
          <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-xl text-lg sm:text-xl font-semibold hover:shadow-2xl hover:scale-105 transition-all">
            Subscribe
          </button>
        </div>
      </div>
